        ...
        <div className="hero">
            <div className="once-in p-8">
                <div >
                    ...
                    <img className='w-14 cursor-pointer hover:sepia' src="https://res.cloudinary.com/beam-sensation/image/upload/v1720735262/portfolio/ag-logo_yy6lau.svg" alt="Oluwafemi Azeez Gafar's brand logo" />
                </div>
                <div className='md:flex mt-16 md:mt-[12em]'>
                    <div className="md:w-1/2 md:text-left px-10">
                        ...
                        <h6 className="md:w-90 text-[1.4em]">I am a result-oriented Frontend Developer with over 5 years of experience and proven
                            knowledge of intuitive multi-user interfaces, web design, and mobile responsive web platform
                            development. I aim to leverage my skills to successfully deliver software solutions and
                            implementations for users.</h6>
                    </div>
                </div>
