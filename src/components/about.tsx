  ...
  return (
    ...
    >
      ...
      <div className="-mt-5 max-w-2xl text-center leading-7">
        ...
        <div className="text-wrap fade-in animate flex justify-center">
          <img src="https://res.cloudinary.com/beam-sensation/image/upload/v1720735141/portfolio/az._qa20qv.jpg"
            alt="" className="deformed-circle magnetic w-[30%]" />
